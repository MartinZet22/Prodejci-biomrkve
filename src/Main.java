public class Main {
    public static void main(String[] args) {
        ...
        ProdejceMrkve prodejce1 =
                new ProdejceMrkve("Karel Mrkvička", "12.03.1955", "Bezděkov 18", 12, 18.5, true);

        ProdejceMrkve prodejce2 =
                new ProdejceMrkve("František Okurka", "25.11.1997", "Lipnice 29", 5, 6.3, false);

        System.out.println();

        System.out.println("Jméno prodejce 1: " + prodejce1.getJmeno());
        System.out.println("Datum narození: " + prodejce1.getDatumNarozeni());
        System.out.println("Věk: " + prodejce1.getVek() + " let");
        System.out.println("Adresa: " + prodejce1.getAdresa());
        ...
        System.out.println("Věk: " + prodejce2.getVek() + " let");
        System.out.println("Adresa: " + prodejce2.getAdresa());
